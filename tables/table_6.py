...
def crop_data(file, sheet_name):
    ...
    row_start, col_start = getIndexes(df, 'Дон ва дуккакли дон экинлари — жами')[0]
...
def add_headers(df_total, file_startswith, sheet_name=0):
    ...
    row, col = getIndexes(df_template, 'Дон ва дуккакли дон экинлари — жами')[0]
    ...
    df_headers.at[row-1, district_col_name] = district_col_name
